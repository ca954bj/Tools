...
class fwebdriver:
	def __init__(self):
		...
		print("edit trial")
		self.driver.find_element_by_xpath("/html/body/div[7]/div[2]/div[2]/div[1]/div[2]/div[68]/div[5]").click()
		time.sleep(1)
		
		try:
			self.driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]").click()
			time.sleep(1)
		except:
			pass
	...
	def edit_and_run(self, distancex, distancey, angle):
		...
		# here is the mission panel
		print("Run")
		self.driver.find_element_by_xpath("/html/body/div[7]/div[2]/div[2]/div[1]/div[2]/div[68]/div[3]").click()
		t1 = time.clock()
		print("Time: %f" % (t1 - t0))
